...
type StreamEvent struct {
	Type              string             `json:"type"` // "output", "state", "created", "deleted", "permission_request", "staged_action"
	AgentID           string             `json:"agent_id"`
	Project           string             `json:"project"`
	...
	StagedAction      *StagedAction      `json:"staged_action,omitempty"`      // For "staged_action" events
}
